* IP spoofing is the creation of IP packets with a forged (spoofed) source IP address, with the purpose of concealing the identity of the sender or impersonating another computing system.
